...
<head>
	...
	<!-- //pie-chart --><!-- index page sales reviews visitors pie chart -->	
	<link href="https://cdn.datatables.net/v/dt/dt-2.1.8/datatables.min.css" rel="stylesheet" type="text/css">
			...
			<aside class="sidebar-left" style="overflow: scroll; height:100%; scrollbar-width: thin;">
				<nav class="navbar navbar-inverse">
					<div class="navbar-header">
						...
						<h1><a class="navbar-brand" href="index.php"><span class="fa fa-globe"></span> Sistema<span class="dashboard_text">Extrafruti</span></a></h1>
					</div>
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<ul class="sidebar-menu">
							...
							<li class="treeview">
								...
								<ul class="treeview-menu">
									<li><a href="index.php?pagina=cadprodutos"><i class="fa fa-angle-right"></i> Cadastro de produtos</a></li>
							</li>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
					...
					<div class="col-md-12">							
								...
								<input type="text" class="form-control" id="conf_senha_perfil" name="conf_senha" placeholder="Seu endereço" value="<?php echo $endereco_usuario ?>">							
						</div>
